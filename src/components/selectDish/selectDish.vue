<template>
    <div>
        <SearchBar/>
        <div class="row" v-for="(dish,index) in dishes"><Dish v-bind:dish-object="dish"></Dish></div>
    </div>
</template>
                    ...
                    "analyzedInstructions": [
                        {
                            ...
                            "steps": [
                                ...
                                {
                                    "number": 2,
                                    "step": "Roll out the pizza dough and place it on the pizza baking selectDish.",
                                    "ingredients": [
                                        {
                                            "id": 93610,
                                            "name": "pizza dough",
